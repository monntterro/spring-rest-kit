...
1. **Обработчик исключений** — создайте класс с `@RestControllerAdvice`, реализующий
   `BaseKitExceptionHandler`
...
4. Все HTTP-методы имеют встроенную Swagger-документацию, которую можно переопределить
